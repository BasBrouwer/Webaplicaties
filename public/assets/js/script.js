...
// =============================================================================
function initMap() {
  var center = new google.maps.LatLng(56.183330, 10.233330);
  var mapOptions = {
    zoom: 5,
    center: center
  };
...
function dataReq() {
  ...
  var token = "?$$app_token=UXXSKk12eqwgjmNvwKQqcx7u6";
  var xmlHttp = new XMLHttpRequest();

  xmlHttp.onreadystatechange = function () {
    if (xmlHttp.readyState == 4 && xmlHttp.status == 200) parseData(xmlHttp.responseText);
  };
...
function marker(markersData) {
  ...
  for (var i = 0; i < markersData.length; i++) {
    var pos = { lat: Number(markersData[i].lat), lng: Number(markersData[i].long) };
...
function infoWindow() {
  ...
  for (var i = 0; i < markers.length; i++) {
    ...
    google.maps.event.addListener(marker, 'click', function () {
      // info van de ma
      var pos = { lat: Number(this.lat), lng: Number(this.long) };
      findHotelsNearby(pos);

      //infowindow
      infowindow.setContent("<h3>" + this.name + "</h3>" + "<ul class='info'>" + "<li><span>Fell:</span> " + this.fall + "</li>" + "<li><span>Year:</span> " + this.year + "</li>" + "<li><span>geo:</span> " + this.position + "</li>" + "<li><span>recclass:</span> " + this.recclass + "</li>" + "<li><span>mass:</span> " + this.mass + "</li>" + "</ul>");
...
// form submit filter
// =============================================================================
(0, _jquery2.default)("#filter_mass").submit(function (evt) {
  evt.preventDefault();
  var getal = (0, _jquery2.default)("#filter_mass").serializeArray();
...
(0, _jquery2.default)("#filter_year").submit(function (evt) {
  evt.preventDefault();
  var getal = (0, _jquery2.default)("#filter_year").serializeArray();
  if (getal[0].value < getal[1].value) {
    console.log("is goed");
    filterYear(getal);
  } else {
...
(0, _jquery2.default)("#filter_found").submit(function (evt) {
  evt.preventDefault();
  var getal = (0, _jquery2.default)("#filter_found").serializeArray();
  filterFound(getal);
});
...
(0, _jquery2.default)("#reset").click(function (evt) {
  evt.preventDefault();
...
function filterMass(filterNumber) {
  ...
  objArrayFiltered = _jquery2.default.grep(objectArray, function (element) {
